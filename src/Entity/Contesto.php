...
#[ORM\Entity(repositoryClass: ContestoRepository::class)]
class Contesto
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
     ...
     */
    #[ORM\OneToMany(targetEntity: Frase::class, mappedBy: 'contesto', orphanRemoval: true)]
    ...
    public function removeFrasi(Frase $frasi): static
    {
        if ($this->frasi->removeElement($frasi)) {
            ...
            if ($frasi->getContesto() === $this) {
                $frasi->setContesto(null);
            }
        }
